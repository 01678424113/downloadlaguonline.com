...
foreach ($data->items as $video) {
    ...
    $ro = mysqli_fetch_array(mysqli_query($conn, "SELECT api FROM video WHERE api='" . $api . "'"));
    if ($ro['api'] != $api) {
...
echo "<meta http-equiv='refresh' content='3;URL=all-video.php'>";
echo "<div style='font-family: Arial, Sans-serif;
	        font-size: 14pt;' align=center>Add video successfully!!!</div>";
?>